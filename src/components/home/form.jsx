...
import img1 from '../../img/crowdsource/1.png';
import img2 from '../../img/crowdsource/2.png';
import img3 from '../../img/crowdsource/3.png';
import img4 from '../../img/crowdsource/4.png';
                ...
                <div className="mb-4">
                    ...
                    <div className="flex justify-evenly">
                        <label htmlFor="waterlevel1" className={`inline-block border-2 ${activeOption === 1 ? "border-red-800" : "border-transparent hover:border-blue-100 "}`} onClick={handleOption(0.2, 1)}>
                            <img src={img1} width={100} height={100} alt="Low water level" />
                        ...
                        <label htmlFor="waterlevel2" className={`inline-block border-2 ${activeOption === 2 ? "border-red-800" : "border-transparent hover:border-blue-100 "}`} onClick={handleOption(0.4, 2)}>
                            <img src={img2} width={100} height={100} alt="Medium water level" />
                        ...
                        <label htmlFor="waterlevel3" className={`inline-block border-2 ${activeOption === 3 ? "border-red-800" : "border-transparent hover:border-blue-100 "}`} onClick={handleOption(0.6, 3)}>
                            <img src={img3} width={100} height={100} alt="High water level" />
                            <span className='w-full flex justify-center text-white text-[.6rem]'>Waist</span>
                        </label>

                        <label htmlFor="waterlevel4" className={`inline-block border-2 ${activeOption === 4 ? "border-red-800" : "border-transparent hover:border-blue-100 "}`} onClick={handleOption(0.9, 4)}>
                            <img src={img4} width={100} height={100} alt="Very High water level" />
